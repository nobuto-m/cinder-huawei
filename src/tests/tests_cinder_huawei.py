...
"""Encapsulate cinder-huawei testing."""
...
class CinderHuaweiTest(test_utils.OpenStackBaseTest):
    """Encapsulate Huawei tests."""

    @classmethod
    def setUpClass(cls):
        """Run class setup for running tests."""
        super(CinderHuaweiTest, cls).setUpClass()
